'''
Project Name	: Jewel Price Data Aggregator                                                                         
Source  		: https://www.grtjewels.com/
Developer		: Subash KS                                                                                         
Developed date	: 2024-11-09                                                                                            
Description     : Scraping up-to-date data for Gold, Platinum, and Silver prices and calculating the daily price differences compared to the previous day.
'''
...
class scrapingClass:
    ...
    def __init__(self, configData):
        ...
        self.cacheFile = f'{cachePath}Jewel_Prize_Page_{self.fileDate}.html'
    ...
    def writingBlock(self):
        ...
        if not df.empty:
            ...
            diffOfG24 = abs(latestData['24K GOLD/1g'] - int(self.dataDict[self.currentDate]['GOLD/24k']['1 g']))
            ...
            diffOfG22 = abs(latestData['22K GOLD/1g'] - int(self.dataDict[self.currentDate]['GOLD/22k']['1 g']))
            ...
            diffOfG18 = abs(latestData['18K GOLD/1g'] - int(self.dataDict[self.currentDate]['GOLD/18k']['1 g']))
            ...
            diffOfP = abs(latestData['PLATINUM/1g'] - int(self.dataDict[self.currentDate]['PLATINUM']['1 g']))
            ...
            diffOfS = abs(latestData['SILVER/1g'] - int(self.dataDict[self.currentDate]['SILVER']['1 g']))
